...
STT_ROLLING=1
STT_PENDING_FLUSH_SEC=1.2         # обрезок «…про» → в transcript
WHISPER_MODEL_SIZE=small
WHISPER_PROMPT_MODE=tech
WHISPER_GLOSSARY_FIXES=1
AUDIO_PRESET=interview            # call | solo | fast | interview
AUDIO_SILENCE_SEC_SELF=0.65
COPILOT_TIMING=1
ANSWER_BARGE_IN_ON_SPEECH=interviewer   # отмена ответа при новой речи; 0 | all
ANSWER_AUTO=1
