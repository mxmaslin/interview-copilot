...
_ANSWER_SYSTEM = (
    ...
    "Вопрос может содержать ошибки STT (например «кавказ/кахо/катастрофа» вместо Kafka): "
    "если по контексту техсобеса и резюме очевиден IT-термин — отвечай по нему, не отказывайся из-за опечатки."
)
